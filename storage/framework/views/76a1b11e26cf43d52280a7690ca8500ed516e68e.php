        ...
        <div class="col-sm-7">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <a href="/admin.item/edit<?php echo e($post->id); ?>" class="btn btn-primary btn-round">
                                <i class="bi bi-pencil-square"></i>
                                Ubah
                            </a>
                        </div>
                        <div class="col-sm">
                            <a href="/admin.item/delete<?php echo e($post->id); ?>" class="btn btn-secondary btn-round">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Jundi\laravel project\AssetManager\resources\views/admin/showItem.blade.php ENDPATH**/ ?>